...
\todo{Do we even need the restriction that $|\many{n}| = 0$?}
...
\inferrule[R-Yield-Can't]
          { \neg (\EF[\EC]~\textsf{allows}~\textsf{Yield}) \\
...
\todo{Talk about how this compares to TFP paper.}
...
\begin{proof}
By induction on the transitions $\redtou, \redtoc$.\todo{Finish this; addition of
new yielding rule.}
\end{proof}
