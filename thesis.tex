...
inconvenient; the programmer must insert \yield{}s with a vaguely constant
frequency, so as to avoid process starvation. It would be better to just use
some automatic way of \yield{}ing.
