...
subject reduction theorem needed for this proof.

%% \begin{restatable}[Subject Reduction]{theorem}{subred}\label{thm:sub-red}
%%   \\
%% \begin{itemize}
...
\begin{proof}
By induction on the transitions.... \todo{Finish this}
\end{proof}


\chapter{Implementation}

We now introduce the Frank library used for asynchronous effects. It is untyped
in that there is no tracking of which asynchronous effects are issued in which
functions, however it is typed in that the traditional Frank effects promises
can perform are tracked. Our design closely follows the
