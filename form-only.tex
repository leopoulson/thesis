...
\inferrule[R-Yield]
  {  }
  { m \redtou \key{let}~\textsf{yield} : [\textsf{Yield}]\textsf{Unit} = \_ \key{in}~m}

\end{mathpar}

\caption{Inserting Yields \todo{Only if yield is in the ability of m?} \todo{How
do we access $m$'s type?}}
